...
module.exports = function(opcClient, WIDTH, HEIGHT)
{
	...
	function colorWipeRange(startPixel, endPixel, red, green, blue) {
	...
	function randomColorWipeRange(startPixel, endPixel) {
		colorWipeRange(startPixel, endPixel, randomColor(), randomColor(), randomColor());
	}
	...
	return {
		...
		colorWipeRange: colorWipeRange,
		randomColorWipeRange: randomColorWipeRange
	};
}