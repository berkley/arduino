...
void loop() 
{
  ...
  // int del = 200;
  // createObj(FLAKE1, LIGHT_WHITE, BLACK);
  // delay(del);
  // createObj(FLAKE2, LIGHT_WHITE, BLACK);
  // delay(del);
  // createObj(FLAKE3, LIGHT_WHITE, BLACK);
  // delay(del);
  // createObj(FLAKE4, LIGHT_WHITE, BLACK);
  // delay(del);
  // createObj(FLAKE5, LIGHT_WHITE, BLACK);
  // delay(del);
  // createObj(FLAKE6, LIGHT_WHITE, BLACK);
  // delay(del);
  // createObj(FLAKE7, LIGHT_WHITE, BLACK);
  // delay(del);
